...
// Default password for pre-seeded users is "123456" or "admin123"
const passwordHashes: Record<string, string> = {
  usr_admin: bcrypt.hashSync('admin123', 10),
  usr_larissa: bcrypt.hashSync('123456', 10),
  usr_michele: bcrypt.hashSync('123456', 10),
  usr_moacir: bcrypt.hashSync('123456', 10),
  usr_karine: bcrypt.hashSync('123456', 10)
};
...
async function startServer() {
  ...
  app.post('/api/auth/login', async (req, res) => {
    ...
    if (hash) {
      ...
      validPassword = password === '123456' || password === 'admin123';
    }

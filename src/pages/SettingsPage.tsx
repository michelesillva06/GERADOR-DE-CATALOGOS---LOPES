...
import { Settings, Save, Building2, CheckCircle2, User as UserIcon, Camera, Upload, Phone, ExternalLink, ShieldCheck, Image as ImageIcon, Trash2, Zap, Bell } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-4xl pb-32 sm:pb-12">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* SECTION: NOTIFICAÇÕES NO CELULAR & WEB PUSH */}
        <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs space-y-4">
          <div className="flex items-center space-x-3 pb-3 border-b border-slate-100">
            ...
            <div>
              <h2 className="text-base font-extrabold text-slate-900">Notificações no Celular & Web Push</h2>
              <p className="text-xs text-slate-500">
                Ative alertas automáticos de imóveis pendentes de atualização e avisos importantes diretamente no seu aparelho.
              </p>
            </div>
          </div>
